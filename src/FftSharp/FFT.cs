...
public static class FFT
{
	...
	public static double[] Real(System.Numerics.Complex[] spectrum, bool positiveOnly = true)
	{
	...
	public static double[] Imaginary(System.Numerics.Complex[] spectrum, bool positiveOnly = true)
	{
		int length = positiveOnly ? spectrum.Length / 2 + 1 : spectrum.Length;
	...
	/// </summary>
	public static double[] Phase(System.Numerics.Complex[] spectrum, bool positiveOnly = true)
	{
		int length = positiveOnly ? spectrum.Length / 2 + 1 : spectrum.Length;
	...
	/// </summary>
	public static double[] Amplitude(System.Numerics.Complex[] spectrum, bool positiveOnly = true)
	{
		int length = positiveOnly ? spectrum.Length / 2 + 1 : spectrum.Length;
	...
	{
		double[] output = Amplitude(spectrum, positiveOnly);
